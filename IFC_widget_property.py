...
class IFC_widget_property(QWidget):
    ...
    def __init__(self):
        ...
        check_associations.setFont(font)
        ...
        check_assignments.setFont(font)
        ...
        check_full_detail.setFont(font)
        ...
        self.property_tree.setFont(font)
        ...
        self.property_tree.setEditTriggers(QAbstractItemView.CurrentChanged)  
        # open editor upon first click
